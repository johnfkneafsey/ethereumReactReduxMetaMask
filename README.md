# Web3 React Redux Starter Kit

## NOTE:
Look at the walkthrough directory to see how web3 was integrated into the original repo.

1. [Blog Post 1](https://medium.com/@angellopozo/a-web3-redux-react-starter-kit-walkthrough-1fff0e9c3c36#.hkqj1eqy5): A Web3-redux-react-starter-kit Walkthrough
2. [Blog Post 2](https://medium.com/@angellopozo/upgrading-to-truffle-3-from-an-existing-truffle-2-project-c0f030b681d3#.g4x4a8lku): Upgrading to truffle 3 from an existing truffle 2 project
